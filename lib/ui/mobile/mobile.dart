...
import '../component/toolbox.dart';
import '../component/utils.dart';
// import 'menu/setting_menu.dart';
...
class MobileHomeState extends State<MobileHomePage> implements EventListener, LifecycleListener {
  ...
  //
  //   if(index == 0){
  //     navigatorHelper.navigator(context, Home(proxyServer: proxyServer, container: container, historyTask: historyTask));
  //   }
  //
  //   if(index == 2){
