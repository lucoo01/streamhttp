...
class _MobileSslState extends State<MobileSslWidget> {
  ...
  void didChangeDependencies() {
    ...
    _appInfo.setSslStatus(widget.proxyServer.enableSsl);
        ...
        body: Column(children: [
          SwitchListTile(
              ...
              onChanged: (val) {
                ...
                // 设置Ssl开启状态
                _appInfo.setSslStatus(val);

                widget.proxyServer.enableSsl = val; // 这个操作将同步回调, 修改configuration的值
    ...
    return ListView(children: [
      ...
      ExpansionTile(
          ...
          children: [
            ...
            //             children: [
            //               Text("1. ${localizations.downloadRootCa}"),
            ...
            TextButton(onPressed: () {}, child: Text("2. ${localizations.installCaDescribe}")),
            Padding(
                padding: const EdgeInsets.only(left: 15),
                child: Image.network("https://foruda.gitee.com/images/1689346516243774963/c56bc546_1073801.png",
                    height: 400)),
            TextButton(onPressed: () {}, child: Text("3. ${localizations.trustCaDescribe}")),
            Padding(
                padding: const EdgeInsets.only(left: 15),
