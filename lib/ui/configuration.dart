...
class ThemeModel {
  ...
  ThemeModel({this.mode = ThemeMode.system, this.useMaterial3 = false});
...
class AppConfiguration {
  ...
  Future<void> initConfig() async {
    ...
    try {
      ...
      _theme = ThemeModel(mode: mode, useMaterial3: config['useMaterial3'] ?? false);
