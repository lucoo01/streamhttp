  ...
  void pcCer() async {
    ...
    if (Platform.isMacOS || Platform.isWindows) {
      list = [
        ...
        const SizedBox(height: 10),
        Platform.isMacOS
            ? Image.network("https://atts.gitschool.cn/streamhttp/img/mac_pingju.png",
                width: 800, height: 500)
            : Row(children: [
                Image.network("https://atts.gitschool.cn/streamhttp/img/mac_pingju2.png",
                    width: 400, height: 400),
                const SizedBox(width: 10),
                Image.network("https://atts.gitschool.cn/streamhttp/img/win_pingju.png",
                    width: 400, height: 400)
              ])
      ];
    } else {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SelectableText.rich(
                        TextSpan(text: "http://www.gitschool.cn", style: TextStyle(decoration: TextDecoration.underline)))
                  ],
                ),
                const SizedBox(height: 10),
                ...
                Row(children: [
                  Column(children: [
                    ...
                    const SizedBox(height: 10),
                    Image.network("https://atts.gitschool.cn/streamhttp/img/ios_pingju.png",
                  ...
                  Column(children: [
                    ...
                    const SizedBox(height: 10),
                    Image.network("https://atts.gitschool.cn/streamhttp/img/ios_pingju2.png",
                        height: 270, width: 300)
                  ])
                ])
              ]);
                        ...
                        body: Padding(
                            ...
                            child: TabBarView(children: [
                              ListView(children: [
                                ...
                                TextButton(
                                    child: Text(
                                        "https://${isCN ? 'gitee' : 'github'}.com/lucoo01/ca/releases"),
                                    onPressed: () {
                                      launchUrl(Uri.parse(
                                          "https://${isCN ? 'gitee' : 'github'}.com/lucoo01/ca/releases"));
                                    }),
                                ...
                                ClipRRect(
                                    child: Align(
                                        ...
                                        child: Image.network(
                                          scale: 0.5,
                                          "https://atts.gitschool.cn/streamhttp/img/pingju.png",
                                          height: 460,
                                        )))
                              ]),
                              ListView(
                                children: [
                                  ...
                                  TextButton(
                                      onPressed: () {
                                        launchUrl(Uri.parse(isCN
                                            ? "https://gitee.com/yepiaohuang/streamhttpmd/blob/master/%E5%AE%89%E5%8D%93%E6%97%A0ROOT%E4%BD%BF%E7%94%A8Xposed%E6%A8%A1%E5%9D%97%E6%8A%93%E5%8C%85.md"
                                            : "https://gitee.com/yepiaohuang/streamhttpmd/blob/master/%E5%AE%89%E5%8D%93%E6%97%A0ROOT%E4%BD%BF%E7%94%A8Xposed%E6%A8%A1%E5%9D%97%E6%8A%93%E5%8C%85.md"));
                                      },
                                  ...
                                  ClipRRect(
                                      child: Align(
                                          ...
                                          heightFactor: .7,
                                          child: Image.network(
                                            "https://atts.gitschool.cn/streamhttp/img/pingju2.png",
                                            height: 530,
                                          )))
                                ],
                              ),
